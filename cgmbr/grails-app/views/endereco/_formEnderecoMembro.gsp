...
<div class="fieldcontain ${hasErrors(bean: membroInstance?.endereco, field: 'pais', 'error')} required">
	...
	<g:select id="pais" name="pais.id" from="${com.endereco.Pais.list()}" optionKey="id" required="" value="${membroInstance?.endereco?.pais?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: membroInstance?.endereco, field: 'estado', 'error')} required">
	...
	<g:select id="estado" name="estado.id" from="${com.endereco.Estado.list()}" optionKey="id" required="" value="${membroInstance?.endereco?.estado?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: membroInstance?.endereco, field: 'cidade', 'error')} required">
	...
	<g:select id="cidade" name="cidade.id" from="${com.endereco.Cidade.list()}" optionKey="id" required="" value="${membroInstance?.endereco?.cidade?.id}" class="many-to-one"/>
</div>
