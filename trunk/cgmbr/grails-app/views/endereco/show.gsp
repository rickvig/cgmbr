...
<body>
	<a href="#show-endereco" class="skip" tabindex="-1">
	...
	<div id="show-endereco" class="content scaffold-show" role="main">
		...
		<ol class="property-list endereco">
			...
			<g:if test="${enderecoInstance?.membro}">
				<li class="fieldcontain">
					<span id="membro-label" class="property-label">
						<g:message code="endereco.pais.label" default="Membro:" />
					</span>

					<span class="property-value" aria-labelledby="membro-label">
						<g:link controller="membro" action="show" id="${enderecoInstance?.membro?.id}">
							${enderecoInstance?.membro?.encodeAsHTML()}
						</g:link>
					</span>
			...
			<g:if test="${enderecoInstance?.pais}">
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="pais-label">
						<g:link controller="pais" action="show" id="${enderecoInstance?.pais?.id}">
							${enderecoInstance?.pais?.encodeAsHTML()}
						</g:link>
					</span>
			...
			<g:if test="${enderecoInstance?.estado}">
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="estado-label">
						<g:link controller="estado" action="show" id="${enderecoInstance?.estado?.id}">
							${enderecoInstance?.estado?.encodeAsHTML()}
						</g:link>
					</span>
			...
			<g:if test="${enderecoInstance?.rua}">
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="rua-label">
						<g:fieldValue bean="${enderecoInstance}" field="rua" />
					</span>
		...
		<g:form>
			<fieldset class="buttons">
				...
				<g:link class="edit" action="edit" id="${enderecoInstance?.id}">
